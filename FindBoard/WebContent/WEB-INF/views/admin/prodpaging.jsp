...
<div class="page text-center" style="height: 40px;">
	<ul class ="pagination pagination-sm">
		...
		<li>
		<a href="/admin/product?curPage=<%=apaging.getStartPage() - apaging.getPageCount() %>"> &laquo; </a>
		</li>
		<% } else { %>
		...
		<li><a href="/admin/product?curPage=<%=apaging.getCurPage() - 1 %>"> &lt; </a></li>
		<% } %>
		<!-- 조건에 만족하지 않으면 아예 안보임 -->
		...
		<li class="active"><a href="/admin/product?curPage=<%=i %>"><%=i %></a></li>
			<% }  else {%>
		<li><a href="/admin/product?curPage=<%=i %>"><%=i %></a></li>
			<% } %>
		<% } %>
		...
		<li><a href="/admin/product?curPage=<%=apaging.getStartPage() + apaging.getPageCount()%>">&raquo;</a></li>
		<% } else {%>
		...
		<li><a href="/admin/product?curPage=<%=apaging.getTotalPage()%>">&rarr;</a></li>
		<% } %>
		<!-- 조건에 만족하지 않으면 아예 안보임 -->
